  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-gray-700 transition-colors duration-200 text-white cursor-pointer"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-40 bg-[#24293f] border border-gray-600 rounded-lg shadow-lg z-50">
          {languages.map((lang) => (
            <button
              key={lang.code}
